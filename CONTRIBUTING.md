...
Whether a pull request is merged into Interzone rests with the project merge maintainers and ultimately the project lead.
...
The Project Interzone compiler will release binaries of each new build on https://interzone.space and on Github.
